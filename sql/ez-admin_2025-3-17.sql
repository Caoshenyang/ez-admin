...
CREATE TABLE `ez_admin_menu`  (
  ...
  `status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '菜单状态【0 正常 1 停用】',
...
-- ----------------------------
INSERT INTO `ez_admin_role` VALUES (1901525301556682754, '超级管理员', 'admin', 999, 1, 0, 'init', NULL, 'init', NULL, '', 0);
...
-- ----------------------------
INSERT INTO `ez_admin_user_role_relation` VALUES (1901525301678317569, 1901525301556682754, 1901525301489573889);
