...
CREATE TABLE `ez_admin_role`  (
  ...
  `role_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '角色权限字符标识',
...
CREATE TABLE `ez_admin_user`  (
  ...
  `status` tinyint UNSIGNED NOT NULL COMMENT '用户状态【0 正常 1 冻结】',
